...
print(f"RA3起义OST: 总{len(files)} 待转{len(pending)}", flush=True)
...
print(f"RA3起义OST完成: {done}/{len(pending)} 失败{failed}", flush=True)
