#!/usr/bin/env python3
#!/usr/bin/env python3
r"""新版(20260823)音乐卡批量转换 F:\存储器备份\2023.1.17 音乐档案（视频+音频混合）
...
WORKER_SCRIPT = ROOT / "_archive2_newver_worker.py"
LOG_FILE = ROOT / "run_archive2_newver.log"

SOURCE = Path(r"F:\存储器备份\2023.1.17 音乐档案")
TARGET = Path(r"D:\开源合集\开源 2022.9.14\芯片音乐\自制芯片音乐\MIDI识别合集\MIDI识别 2026\20260824\音乐档案")
WORK_DIR = TARGET / "_work4"
...
def main():
    ...
    log("=" * 50)
    log("新版(20260823) 音乐档案剩余全量(排除MP3格式/CD翻录/x88)")
    log(f"源: {SOURCE}")
    log(f"目标: {TARGET}")
