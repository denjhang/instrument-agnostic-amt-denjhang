...
est_path_len = len(str(out_root)) + len(orig_stem) * 3 + 60
need_short = est_path_len > 240 or len(orig_stem) > 40
if need_short:
...
r = nb.run_stem_separated_transcription(
    run_audio, checkpoint_path=None, output_root=str(out_root),
