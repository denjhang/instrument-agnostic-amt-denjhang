#!/usr/bin/env python3
#!/usr/bin/env python3
r"""新版(20260823)音乐卡批量转换 F:\存储器备份\2023.1.17 音乐档案\未分类\Music SD（视频+音频混合）
...
WORKER_SCRIPT = ROOT / "_qq_netease_newver_worker.py"
LOG_FILE = ROOT / "run_qq_netease_newver.log"
...
def main():
    ...
    log("=" * 50)
    log("新版(20260823) Music SD的qq音乐+网易云音乐")
    log(f"源: {SOURCE}")
    log(f"目标: {TARGET}")
