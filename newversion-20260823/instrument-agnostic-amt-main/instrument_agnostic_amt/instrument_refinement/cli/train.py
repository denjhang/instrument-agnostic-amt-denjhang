...
典型的な使い方は、AMT の学習済み重みで backbone を初期化してから学習を始める::
    ...
    python train_instrument_refinement.py --init-amt checkpoints/best_model.pth
...
from ..training.collate import collate_refinement_batch
from ..training.dataset import (
    ClassBalancedSampler,
    ManifestInstrumentRefinementDataset,
)
from ..training.forward import forward_refinement_batch, move_batch_to_device
