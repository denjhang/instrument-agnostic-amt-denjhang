...
def _ensure_checkpoint(
    ...
    if checkpoint_path is None:
        if model_type == "bass":
            ...
            checkpoint_path = Path("checkpoints/best_model_other.pth")
            url = "https://huggingface.co/anime-song/instrument_agnostic_amt/resolve/main/best_model_other.pth?download=true"
        else:
